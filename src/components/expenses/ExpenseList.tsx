...
import { Receipt, MessageCircle, RotateCw } from 'lucide-react';
...
export function ExpenseList({ egresos }: { egresos: Egreso[] }) {
  ...
  if (egresos.length === 0) {
    return (
      <div className="rounded-3xl bg-card p-12 text-center shadow-sm">
        ...
        <h3 className="font-semibold">Aún no has registrado gastos</h3>
